 ...
 * among threads using the queue data structure.
 */
package osp.Threads;
...
public class ThreadCB extends IflThreadCB {
	public static GenericList readyQueue;
	/**
	...
	public static void init() {
		//Initialize the readyQueue used to store the ready threads
	...
	static public ThreadCB do_create(TaskCB task) {
		...
		//Place this new ready thread to the readyQueue
	 ...
	 */
	public void do_kill() {	  
		//Remove the ready thread from the readyQueue
	...
	public void do_suspend(Event event) {
		...
		//Ensure that the suspended thread is not on the readyQueue
	...
	public void do_resume() {
		...
		//Put the thread on the ready queue if its status is ready
		if (getStatus() == ThreadReady) {
	...
	public static int do_dispatch() {
		...
		if (MMU.getPTBR() != null) {
			...
			//append the preempted thread to the readyQueue
			readyQueue.append(currentlyRunningThread);
		}
		...
		//Select the thread from the head of the readyQueue for dispatch
		ThreadCB newThread = (ThreadCB) readyQueue.removeHead();
